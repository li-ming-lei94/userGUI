...
//                  SPFD5408/1505/B505/C505/NT35310/NT35510/ssd1289等		    
//正点原子@ALIENTEK
...
u16 LCD_ReadPoint(u16 x,u16 y)
{
	...
	if(lcddev.id==0X9325||lcddev.id==0X4535||lcddev.id==0X4531||lcddev.id==0XB505||lcddev.id==0XC505||lcddev.id==0X8989)return r;	//这几种IC直接返回颜色值
...
{ 	
  ...
  RCC_AHBPeriphClockCmd(RCC_AHBPeriph_FSMC,ENABLE);	//使能FSMC时钟
	RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOA|RCC_APB2Periph_GPIOD|RCC_APB2Periph_GPIOE|RCC_APB2Periph_GPIOF|RCC_APB2Periph_GPIOG,ENABLE);//使能PORTB,D,E,G以及AFIO复用功能时钟

...
{	
	  GPIO_InitTypeDef  GPIO_InitStructure;
		...
		GPIO_InitStructure.GPIO_Pin = GPIO_Pin_12|GPIO_Pin_13|GPIO_Pin_15;				 // 端口配置
	 	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP; 		 //推挽输出
	 	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
	 	GPIO_Init(GPIOB, &GPIO_InitStructure);//推挽输出
		...
		GPIO_InitStructure.GPIO_Pin = GPIO_Pin_7;				 // PG7端口配置
	 	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IPU; 		 //上拉输入
	 	GPIO_Init(GPIOG, &GPIO_InitStructure);//PG7上拉输入
